...
void MainWindow::setupUi() {
    ...
    auto* titleLabel = new QLabel("<b>RTSP 30-CAMERA GRID</b> <span style='color: #38bdf8;'>Qt6 GPU Zero-Copy Benchmark</span> <span style='background: #1e293b; color: #38bdf8; padding: 2px 6px; border-radius: 4px; font-size: 11px;'>2560×1440 (1440p)</span>", this);
